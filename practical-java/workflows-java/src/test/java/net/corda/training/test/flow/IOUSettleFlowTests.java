...
import net.corda.training.test.contract.IOUSettleTests;
...
//
//                assertTrue(outputIOU.amount.equals(correctOutputIOU.amount));
//                assertTrue(outputIOU.paid.equals(correctOutputIOU.paid));
//                assertTrue(outputIOU.lender.equals(correctOutputIOU.lender));
//                assertTrue(outputIOU.borrower.equals(correctOutputIOU.borrower));
//
...
//                }
//
//                assertTrue(outputCashSum.equals(inputIOU.amount.minus(inputIOU.paid).minus(outputIOU.paid)));
//
//                CommandWithParties command = ledgerTx.getCommands().get(0);
//                assertTrue(command.getValue().equals(new IOUContract.Commands.Settle()));
//
...
//    /**
//     * Task 2.
//     * The IOU state should also be removed if has been fully settled after multiple settle flows.
//     * TODO: Make sure that there is no IOUState in the output if the IOU is fully settled
//     */
//    @Test
//    public void flowWorksForPartialTransactions() throws Exception {
//        SignedTransaction stx = issueIOU(new IOUState(Currencies.POUNDS(10), b.getInfo().getLegalIdentities().get(0), a.getInfo().getLegalIdentities().get(0)));
//        issueCash(Currencies.POUNDS(20));
//        IOUState inputIOU = stx.getTx().outputsOfType(IOUState.class).get(0);
//        IOUSettleFlow.InitiatorFlow flow = new IOUSettleFlow.InitiatorFlow(inputIOU.getLinearId(), Currencies.POUNDS(5));
//        Future<SignedTransaction> futureSettleResult = a.startFlow(flow);
//
...
//
//        flow = new IOUSettleFlow.InitiatorFlow(inputIOU.getLinearId(), Currencies.POUNDS(5));
//        futureSettleResult = a.startFlow(flow);
//
...
//            try {
//                LedgerTransaction ledgerTx = settleResult.toLedgerTransaction(a.getServices(), false);
//                assert(ledgerTx.outputsOfType(IOUState.class).size() == 0);
//                return null;
//            } catch (Exception exception) {
//                System.out.println(exception);
//            }
...
//        }
//        assert e != null;
//        assert e.getMessage().equals("java.lang.IllegalArgumentException: The borrower must issue the flow");
//    }
//
//    /**
//     * Task 4.
...
//        }
//        assert e != null;
//        assert e.getMessage().equals("java.lang.IllegalArgumentException: Borrower has no GBP to settle.");
//    }
//
//    /**
//     * Task 5.
...
//        }
//        assert(e != null);
//        assert e.getMessage().equals("java.lang.IllegalArgumentException: Borrower doesn't have enough cash to settle with the amount specified.");
//    }
//
//    /**
//     * Task 6.
...
//        } catch (Exception exception) {
//            // Should not reach here. As verifyRequiredSignatures should not throw an error
//            System.out.println(exception.toString());
//            assert false;
//        }
//    }
