...
public class IOUSettleFlow {
    ...
    public static class InitiatorFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            if(results.getStates().size() < 1) throw new IllegalArgumentException("There was no input state available.");
            ...
            CashUtils.generateSpend(getServiceHub(), tb, amount, getOurIdentityAndCert(), counterparty, ImmutableSet.of(), false).getSecond();
